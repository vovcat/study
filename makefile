...
cvq_win.exe: cvq_win.cpp
	i686-w64-mingw32-g++ -g -O0 -Wall -Wextra -mwindows -static-libgcc -static-libstdc++ cvq_win.cpp -o $@ #&& wine ./cvq_win.exe
cv_win.exe: cv_win.cpp
	i686-w64-mingw32-g++ -g -O0 -Wall -Wextra -mwindows -static-libgcc -static-libstdc++ cv_win.cpp -o $@ #&& wine ./cv_win.exe
wx_all: wx_all.cpp wxasm.cpp auto.h debX11.cpp debWin.cpp
	g++ -g -O0 -Wall -Wextra -fno-exceptions -fno-rtti wx_all.cpp wxasm.cpp -o $@ -lX11 -lXext -lpthread #&& ./wx_all
wx_all.exe: wx_all.cpp wxasm.cpp auto.h debX11.cpp debWin.cpp
	i686-w64-mingw32-g++ -g -O0 -Wall -Wextra -fno-exceptions -fno-rtti -mwindows -static-libgcc -static-libstdc++ wx_all.cpp wxasm.cpp -o $@ -lgdi32 -lws2_32 -lwinmm -lavrt -ldwmapi #&& wine ./wx_all.exe
wx: wx.cpp font8x13.s wxasm.cpp
	g++ -g -O0 -Wall -Wextra -fno-exceptions -fno-rtti wx.cpp font8x13.s wxasm.cpp -o $@ -lX11 -lXext -lpthread #&& ./wx
wx.exe: wx.cpp font8x13.s wxasm.cpp
	i686-w64-mingw32-g++ -g -O0 -Wall -Wextra -fno-exceptions -fno-rtti -mwindows -static-libgcc -static-libstdc++ wx.cpp font8x13.s wxasm.cpp -o $@ -lgdi32 -lws2_32 -lwinmm -lavrt -ldwmapi #&& wine ./wx.exe
asm1: wx.cpp font8x13.s asm1s.S asm1.cpp
	g++ -g -O0 -Wall -Wextra -fno-exceptions -fno-rtti wx.cpp font8x13.s asm1s.S asm1.cpp -o $@ -lX11 -lXext -lpthread
...
test_usleep: test_usleep.cpp
	g++ -g -O0 -Wall -Wextra test_usleep.cpp -o $@
test_usleep.exe: test_usleep.cpp
	i686-w64-mingw32-g++ -g -O0 -Wall -Wextra -mconsole -static-libgcc -static-libstdc++ test_usleep.cpp -o $@ -lws2_32 -lwinmm -lavrt -Wl,-Bstatic -lwinpthread -Wl,-Bdynamic
